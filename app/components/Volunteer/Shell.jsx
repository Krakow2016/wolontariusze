...
var Volunteer = React.createClass({
  ...
  render: function () {
    ...
    var email
    var tabs = [
      <NavLink href={"/wolontariusz/" + this.props.profile.id} className="profile-ribon-cell">
        <b id="profile-ribon-txt">Profil</b>
      </NavLink>,
      <NavLink href={"/wolontariusz/" + this.props.profile.id +'/aktywnosci'} className="profile-ribon-cell">
    ...
    if(user) {
      tabs.push(
        <NavLink href={"/wolontariusz/" + this.props.profile.id +'/grafik'} className="profile-ribon-cell">
          <b id="profile-ribon-txt">Grafik</b>
        </NavLink>
      )
      if(user.is_admin) {
        tabs.push(
          <NavLink href={"/wolontariusz/" + this.props.profile.id +'/admin'} className="profile-ribon-cell">
