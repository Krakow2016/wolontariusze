    ...
    return (
      <div className="content-texts-container">
      	<div className="content-texts">
	        ...
	        <ul>
	        	<li>Indywidualne profile dają możliwość udziału w wydarzeniach, umieszczania wpisów czy  dzielenia się efektami swojej pracy. Połączenie z Instagramem pomoże w uwiecznianiu najwspanialszych momentów.
	        	</li>
	        	<li>
